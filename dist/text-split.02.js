(() => {
  ...
  var it = {
    ...
    mi = function (t) {
      ...
      for (r = t.length; r--; )
        (t[r] && (t[r]._gsap || (t[r]._gsap = new xi(t[r], i)))) ||
          t.splice(r, 1);
      return t;
    },
    Pt = function (t) {
    ...
    gi = function (t, e, i) {
      return (i = t[e]) && z(i)
        ? t[e]()
        : (Fe(i) && t.getAttribute && t.getAttribute(e)) || i;
    },
    K = function (t, e) {
    ...
    lr = function (t) {
      var e = parseFloat(t);
      return (e || e === 0) && (t + "").match(sr).length < 2
        ? e
        : $(t)
        ? t.trim()
        : t;
    ...
    ce = function (t) {
      var e = t.parent || R,
        i = t.keyframes ? bn(j(t.keyframes)) : ft;
      if (et(t.inherit))
    ...
    dr = function (t, e) {
      ...
      if (
        ((e._time || (e._initted && !e._dur)) &&
          ((i = Ae(t.rawTime(), e)),
          (!e._dur || ge(0, e.totalDuration(), i) - e._tTime > M) &&
            e.render(i, !0)),
    ...
    lt = function (t, e, i, r) {
      return (
        ...
        ni(e) || (t._recent = e),
        r || dr(t, e),
        t._ts < 0 && Ie(t, t._tTime),
        t
      );
    },
    pr = function (t, e) {
      return (
        (rt.ScrollTrigger || Le("scrollTrigger", e)) &&
    ...
    kn = function (t, e, i, r) {
      var n = t.ratio,
        s =
          e < 0 ||
          (!e &&
            ((!t._start && On(t) && !(!t._initted && ni(t))) ||
              ((t._ts < 0 || t._dp._ts < 0) && !ni(t))))
            ? 0
            : 1,
        a = t._rDelay,
        u = 0,
        ...
        ? ((u = e.charAt(0)),
          ...
          u === "<" || u === ">"
            ...
            : ((u = parseFloat(e.charAt(a - 1) + e.substr(a + 1))),
              f && i && (u = (u / 100) * (j(i) ? i[0] : i).totalDuration()),
    ...
    _e = function (t, e, i) {
      ...
      if ((r && (s.duration = e[1]), (s.parent = i), t)) {
        for (a = s, u = i; u && !("immediateRender" in a); )
          (a = u.vars.defaults || {}), (u = et(u.vars.inherit) && u.parent);
        (s.immediateRender = et(a.immediateRender)),
    ...
    An = function (t, e, i) {
      return (
        ...
        t.forEach(function (r) {
          var n;
          return ($(r) && !e) || gr(r, 1)
            ? (n = i).push.apply(n, at(r))
            : i.push(r);
        }) || i
      );
    },
    at = function (t, e, i) {
      return U && !e && U.selector
        ? U.selector(t)
        : $(t) && !i && (ei || !Jt())
        ? si.call((e || _i).querySelectorAll(t), 0)
        : j(t)
        ? An(t, i)
        : gr(t)
        ? si.call(t, 0)
        ...
        function (e) {
          ...
          return at(
            ...
            i.querySelectorAll
              ? i
              : i === t
              ? Ee("Invalid scope") || _i.createElement("div")
              : t
          );
        }
      );
        ...
        function (_, d, p) {
          ...
          if (!m) {
            if (((w = e.grid === "auto" ? 0 : (e.grid || [1, ot])[1]), !w)) {
              for (
                C = -ot;
                C < (C = p[w++].getBoundingClientRect().left) && w < l;
            ...
            for (
              m = s[l] = [],
                x = u ? Math.min(w, l) * h - 0.5 : r % w,
                v = w === ot ? 0 : u ? (l * c) / w - 0.5 : (r / w) | 0,
                C = 0,
                b = ot,
                S = 0;
              S < l;
    ...
    ie = function (t) {
      for (var e = 0, i = "", r, n, s, a; ~(r = t.indexOf("random(", e)); )
        (s = t.indexOf(")", r)),
          (a = t.charAt(r + 7) === "["),
          (n = t.substr(r + 7, s - r - 7).match(a ? sr : ti)),
          (i +=
            t.substr(e, r - e) +
            Tr(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5)),
          (e = s + 1);
    ...
    In = function o(t, e, i, r) {
      ...
      if (!n) {
        ...
        if ((i === !0 && (r = 1) && (i = null), s))
          ...
          for (h = [], c = t.length, _ = c - 2, f = 1; f < c; f++)
            h.push(o(t[f - 1], t[f]));
          c--,
            (n = function (p) {
              p *= c;
    ...
    Bn = function (t) {
      ...
      var e = t.name,
        ...
        s = { targetTest: 0, get: 0, getSetter: Be, aliases: {}, register: 0 };
      if ((Jt(), t !== r)) {
        if (J[e]) return;
        ft(r, ft(De(t, n), s)),
          It(r.prototype, It(n, De(t, s))),
          (J[(r.prop = e)] = r),
          t.targetTest && (Pe.push(r), (di[e] = 1)),
          (e =
    ...
    Ji = function (t, e, i) {
      ...
      if (
        ...
        for (f = t.replace(gt, "1").split(Bt), c = f.length - 1; a < c; a++)
          r +=
            f[a] +
            (~u.indexOf(a)
              ? n.shift() || s + "0,0,0,0)"
      ...
      if (!f)
        for (f = t.split(gt), c = f.length - 1; a < c; a++) r += f[a] + n[a];
      return r + f[c];
    },
    gt = (function () {
      var o =
    ...
    $n = function (t) {
      for (
        ...
        (u = i[n]),
          ...
          (f = u.substr(0, a)),
          (e[r] = isNaN(f) ? f.replace(Wn, "").trim() : +f),
          (r = u.substr(a + 1).trim());
      return e;
    },
    Yn = function (t) {
    ...
    Xn = function (t) {
      ...
      return i && e.length > 1 && i.config
        ? i.config.apply(
            null,
            ~t.indexOf("{") ? [$n(e[1])] : Yn(t).split(",").map(lr)
          )
        : k._CE && Un.test(t)
        ? k._CE("", t)
        : i;
      ...
      return (
        ...
        (t.totalTime = function (i, r) {
          ...
          if (n && n.smoothChildTiming && this._ts) {
            for (
              Ie(this, i), !n._dp || n.parent || dr(n, this);
              n && n.parent;
          ...
          return (
            (this._tTime !== i ||
              ...
              (this._ts || (this._pTime = i), hr(this, i, r)),
            this
          );
        }),
        (t.time = function (i, r) {
        ...
        (t.startTime = function (i) {
          if (arguments.length) {
            ...
            return (
              r && (r._sort || !this.parent) && lt(r, this, i - this._delay),
              this
            );
          }
          return this._start;
        ...
        (t.repeat = function (i) {
          return arguments.length
            ? ((this._repeat = i === 1 / 0 ? -2 : i), Ki(this))
            : this._repeat === -2
            ? 1 / 0
            : this._repeat;
        }),
    ...
    return (
      ...
      (e.set = function (r, n, s) {
        return (
          (n.duration = 0),
          (n.parent = this),
          ce(n).repeatDelay || (n.repeat = 0),
          (n.immediateRender = !!n.immediateRender),
          new V(r, n, nt(this, s), 1),
          this
        );
      }),
      ...
      (e.staggerFrom = function (r, n, s, a, u, f, h) {
        return (
          (s.runBackwards = 1),
          (ce(s).immediateRender = et(s.immediateRender)),
      ...
      (e.staggerFromTo = function (r, n, s, a, u, f, h, c) {
        return (
          (a.startAt = s),
          (ce(a).immediateRender = et(a.immediateRender)),
          this.staggerTo(r, n, a, u, f, h, c)
        );
      }),
      (e.render = function (r, n, s) {
        ...
        if (
          ...
          if (
            ...
            (T = this._ts),
            (x = !T),
            c && (f || (a = this._zTime), (r || !n) && (this._zTime = r)),
            this._repeat)
          ) {
            if (
              ((S = this._yoyo),
          ...
          if (
            (this._hasPause &&
              !this._forcing &&
              this._lock < 2 &&
              ((v = En(this, Y(a), Y(_))), v && (h -= _ - (_ = v._start))),
            (this._tTime = h),
            (this._time = _),
            (this._act = !T),
            this._initted ||
          ...
          if (_ >= a && r >= 0)
            for (d = this._first; d; ) {
              if (
                ((p = d._next), (d._act || _ >= d._start) && d._ts && v !== d)
              ) {
            ...
            for (var P = r < 0 ? r : _; d; ) {
              if (
                ((p = d._prev), (d._act || P <= d._end) && d._ts && v !== d)
              ) {
                if (d.parent !== this) return this.render(r, n, s);
                if (
                  (d.render(
            ...
            ((h === u && this._tTime >= this.totalDuration()) || (!h && a)) &&
              ...
              (this._lock ||
                ...
                !n &&
                  ...
                  (ut(
                    this,
                    h === u && r >= 0 ? "onComplete" : "onReverseComplete",
                    !0
                  ),
                  this._prom &&
      ...
      (e.addPause = function (r, n, s) {
        ...
        return (
          (a.data = "isPause"), (this._hasPause = 1), lt(this, a, nt(this, r))
        );
      }),
      ...
      (t.updateRoot = function (r) {
        if ((R._ts && (hr(R, Ae(r, R)), (fr = tt.frame)), tt.frame >= ji)) {
          ji += it.autoSleep || 120;
          var n = R._first;
  ...
  var qn = function (t, e, i, r, n, s, a) {
      ...
      for (
        ...
        (p = c[0]),
          ...
          p !== _[h++] &&
            ((m = parseFloat(_[h - 1]) || 0),
            (u._pt = {
              _next: u._pt,
              p: l || h === 1 ? l : ",",
              s: m,
              c: p.charAt(1) === "=" ? Vt(m, p) - m : parseFloat(p) - m,
      ...
      if (
        ...
        return !isNaN(_ * r) && r !== ""
          ? ((p = new Z(
            ...
            (this._pt = p))
          : (!c && !(e in t) && Le(e, r),
            qn.call(this, t, e, _, r, d, u || it.stringFilter, f));
    },
    Gn = function (t, e, i, r, n) {
      if (
        (z(t) && (t = de(t, n, e, i, r)),
        !ct(t) || (t.style && t.nodeType) || j(t) || nr(t))
      )
        return $(t) ? de(t, n, e, i, r) : t;
      var s = {},
        a;
    ...
    Ti = function (t, e, i, r, n, s) {
      ...
      if (
        ...
        (a = new J[t]()).init(
          n,
          a.rawVars ? e[t] : Gn(e[t], r, n, s, i),
          i,
          r,
          s
        ) !== !1 &&
        ((i._pt = u = new Z(i._pt, n, t, 0, 1, a.render, a, 0, a.priority)),
        i !== Ht)
      )
    ...
    wi = function o(t, e, i) {
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            (t._startAt._dp = 0),
            (t._startAt._sat = t),
            e < 0 && (G || (!a && !l)) && t._startAt.revert(Ce),
            a && m && e <= 0 && i <= 0)
          ) {
            e && (t._zTime = e);
            return;
          ...
          if (
            ...
            (t._startAt._dp = 0),
            (t._startAt._sat = t),
            e < 0 && (G ? t._startAt.revert(Ce) : t._startAt.render(-1, !0)),
            (t._zTime = e),
            !a)
          )
            o(t._startAt, M, M);
        ...
        for (
          t._pt = t._ptCache = 0, u = (m && et(u)) || (u && !m), b = 0;
          b < v.length;
          b++
        ) {
          if (
            ...
            (B = y === v ? b : y.indexOf(O)),
            I &&
              (A = new I()).init(O, H || C, t, B, y) !== !1 &&
              ((t._pt = P =
                new Z(t._pt, O, A.name, 0, 1, A.render, A, 0, A.priority)),
            ...
            for (w in C)
              J[w] && (A = Ti(w, C, t, B, O, y))
                ? A.priority && (D = 1)
                : (W[w] = P =
                    vi.call(t, O, w, "get", C[w], B, y, 0, r.stringFilter));
          t._op && t._op[b] && t.kill(O, t._op[b]),
            g &&
              t._pt &&
              ((St = t),
              R.killTweensOf(O, W, t.globalTime(e)),
              (At = !t.parent),
              (St = 0)),
            t._pt && u && (ii[L.id] = 1);
        }
      ...
      (t._onUpdate = f),
        ...
        p && e <= 0 && S.render(ot, !0, !0);
    },
    jn = function (t, e, i, r, n, s, a) {
      ...
      if (!u)
        for (
          u = t._ptCache[e] = [], c = t._ptLookup, _ = t._targets.length;
          _--;

        ) {
          if (((f = c[_][e]), f && f.d && f.d._pt))
  ...
  var V = (function (o) {
    ...
    function t(i, r, n, s) {
      ...
      var u = a.vars,
        ...
        x = u.yoyoEase,
        v = r.parent || R,
        T = (j(i) || nr(i) ? yt(i[0]) : "length" in r) ? [i] : at(i),
        y,
        g,
        S,
        C,
      ...
      if (
        ...
        if (
          ...
          if (((C = T.length), (P = _ && xr(_)), ct(_)))
            for (b in _) ~Er.indexOf(b) && (O || (O = {}), (O[b] = _[b]));
          for (g = 0; g < C; g++)
            (S = De(r, Mr)),
              (S.stagger = 0),
              x && (S.yoyoEase = x),
          ...
          ce(ft(y.vars.defaults, { ease: "none" })),
            (y._ease = Nt(p.ease || r.ease || "none"));
          var D = 0,
            L,
            I,
            A;
          if (j(p))
            ...
            S = {};
            for (b in p)
              b === "ease" || b === "easeEach" || Qn(b, p[b], S, p.easeEach);
            for (b in S)
              for (
                L = S[b].sort(function (W, B) {
                  return W.t - B.t;
                }),
                  D = 0,
                  g = 0;
                ...
                (I = L[g]),
                  (A = {
                    ease: I.e,
                    duration: ((I.t - (g ? L[g - 1].t : 0)) / 100) * f,
                  }),
                  (A[b] = I.v),
                  y.to(T, A, D),
                  (D += A.duration);
    ...
    return (
      (e.render = function (r, n, s) {
        ...
        if (!f) kn(this, r, n, s);
          ...
          if (((_ = c), (T = this.timeline), this._repeat)) {
            ...
            p !== m &&
              (T && this._yEase && Or(T, x),
              this.vars.repeatRefresh &&
                !x &&
                !this._lock &&
                ((this._lock = s = 1),
                (this.render(Y(l * p), !0).invalidate()._lock = 0)));
          }
          if (!this._initted) {
          ...
          (T &&
            T.render(
              r < 0 ? r : !_ && x ? -M : T._dur * T._ease(_ / this._dur),
              n,
              s
            )) ||
            ...
            this._onUpdate &&
              !n &&
              (h && ri(this, r, n, s), ut(this, "onUpdate")),
            this._repeat &&
              p !== m &&
              this.vars.onRepeat &&
              !n &&
            ...
            (c === this._tDur || !c) &&
              ...
              !n &&
                !(h && !a) &&
                (c || a || x) &&
                (ut(this, c === u ? "onComplete" : "onReverseComplete", !0),
                this._prom &&
      ...
      (e.kill = function (r, n) {
        ...
        if (this.timeline) {
          ...
          return (
            this.timeline.killTweensOf(r, n, St && St.vars.overwrite !== !0)
              ._first || he(this),
            this.parent &&
              s !== this.timeline.totalDuration() &&
              Zt(this, (this._dur * this.timeline._tDur) / s, 0, 1),
            this
          );
        }
        var a = this._targets,
        ...
        (t.add = function (i, r, n) {
          ...
          for (f in i)
            f === "all"
              ...
              : ((u = st.matchMedia(i[f])),
                u &&
                  (ee.indexOf(s) < 0 && ee.push(s),
                  (a[f] = u.matches) && (h = 1),
                  u.addListener
                    ? u.addListener(fi)
                    : u.addEventListener("change", fi)));
          return h && r(s), this;
        }),
        (t.revert = function (i) {
          this.kill(i || {});
    ...
    Re = {
      ...
      registerEffect: function (t) {
        ...
        (r || "").split(",").forEach(function (a) {
          return (
            a && !J[a] && !rt[a] && Ee(e + " effect requires " + a + " plugin.")
          );
        }),
          (Ge[e] = function (a, u, f) {
          ...
          s &&
            (q.prototype[e] = function (a, u, f) {
              return this.add(Ge[e](a, ct(u) ? u : (f = u) && {}, this), f);
            });
      },
  ...
  var Fr,
    ...
    Bs = function () {
      ...
      for (n = 0; n < t.length; n += 3)
        t[n + 1]
          ...
          : t[n + 2]
          ? (i[t[n]] = t[n + 2])
          : i.removeProperty(t[n].replace(Li, "-$1").toLowerCase());
      if (this.tfm) {
        ...
        r.svg &&
          ...
          (n = Fi()),
          n && !n.isStart && !i[F] && (Xr(i), (r.uncache = 1));
      }
    },
    qr = function (t, e) {
      var i = { target: t, props: [], revert: Bs, save: Is };
      return (
        e &&
    ...
    _t = function o(t, e, i) {
      ...
      return (
        r[e] ||
        r.getPropertyValue(e.replace(Li, "-$1").toLowerCase()) ||
        ...
        e in Tt && e !== ht && (e = F),
          i.removeProperty
            ? ((e.substr(0, 2) === "ms" || e.substr(0, 6) === "webkit") &&
                (e = "-" + e),
              i.removeProperty(e.replace(Li, "-$1").toLowerCase()))
            : i.removeAttribute(e);
      }
    },
    ...
    Dt = function o(t, e, i, r) {
      var n = parseFloat(i) || 0,
        ...
        m,
        x;
      return r === s || !n || Br[r] || Br[s]
        ? n
        : (s !== "px" && !_ && (n = o(t, e, i, "px")),
          (x = t.getCTM && Hr(t)),
          (d || s === "%") && (Tt[e] || ~e.indexOf("adius"))
            ? ((p = x ? t.getBBox()[u ? "width" : "height"] : t[h]),
              N(d ? (n / p) * c : (n / 100) * p))
    ...
    Us = function (t, e, i, r) {
      if (!i || i === "none") {
        ...
        s && s !== i
          ? ((e = n), (i = s))
          : e === "borderColor" && (i = _t(t, "borderTopColor"));
      }
      ...
      if (
        ...
        (r += ""),
        r === "auto" &&
          ((t.style[e] = r), (r = _t(t, e) || r), (t.style[e] = i)),
        (h = [i, r]),
        yi(h),
        (i = h[0]),
        (r = h[1]),
        ...
        for (; (c = Bt.exec(r)); )
          (m = c[0]),
            ...
            m !== (l = _[f++] || "") &&
              ...
              (x = parseFloat(m)),
              (T = m.substr((x + "").length)),
              (u = Bt.lastIndex - T.length),
              T ||
                ((T = T || it.units[e] || y),
                u === r.length && ((r += T), (a.e += T))),
              y !== T && (d = Dt(t, e, l, T) || 0),
              (a._pt = {
                _next: a._pt,
                p: v || f === 1 ? v : ",",
      ...
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if (n === "all" || n === !0) (r.cssText = ""), (u = 1);
          ...
          for (n = n.split(","), f = n.length; --f > -1; )
            (a = n[f]),
              Tt[a] && ((u = 1), (a = a === "transformOrigin" ? ht : F)),
              xe(i, a);
        u &&
          (xe(i, F),
          s &&
    ...
    zi = function (t, e) {
      ...
      return i.svg && t.getAttribute("transform")
        ...
        : (n === ve &&
            ...
            (s = t.parentNode),
            (!s || !t.offsetParent) &&
              ((f = 1), (a = t.nextElementSibling), ne.appendChild(t)),
            (n = Ur(t)),
    ...
    Ai = function (t, e, i, r, n, s) {
      ...
      i
        ? u !== ve &&
          (C = d * m - p * l) &&
          ((b = y * (m / C) + g * (-l / C) + (l * v - m * x) / C),
          (w = y * (-p / C) + g * (d / C) - (d * v - p * x) / C),
          (y = b),
          (g = w))
        : ((S = jr(t)),
          (y = S.x + (~T[0].indexOf("%") ? (y / 100) * S.width : y)),
          (g =
            S.y + (~(T[1] || T[0]).indexOf("%") ? (g / 100) * S.height : g))),
        r || (r !== !1 && a.smooth)
          ? ((x = y - f),
            (v = g - h),
            (a.xOffset = c + (x * d + v * l) - x),
            (a.yOffset = _ + (x * p + v * m) - v))
        ...
        s &&
          (Mt(s, a, "xOrigin", f, y),
          Mt(s, a, "yOrigin", h, g),
          Mt(s, a, "xOffset", c, a.xOffset),
          Mt(s, a, "yOffset", _, a.yOffset)),
    ...
    Te = function (t, e) {
      ...
      return (
        ...
        i.svg &&
          ...
          Ai(t, B || f, !!B || i.originIsAbsolute, i.smooth !== !1, C)),
        (g = i.xOrigin || 0),
        (S = i.yOrigin || 0),
        C !== ve &&
          ((O = C[0]),
          ...
          i.svg &&
            ...
            (i.forceCSS = t.setAttribute("transform", "") || !Kr(_t(t, F))),
        ...
        (i.renderTransform = i.svg ? Xs : Gr ? Zr : Ys),
        (i.uncache = 0),
        i
      );
    },
      ...
      (u = parseFloat(u)),
        ...
        u || f
          ? ((u *= se),
            ...
            (b = N(b)))
          : ((g = c), (b = _), (S = C = 0)),
        ((T && !~(s + "").indexOf("px")) || (y && !~(a + "").indexOf("px"))) &&
          ((T = Dt(d, "x", s, "px")), (y = Dt(d, "y", a, "px"))),
        (p || l || m || x) &&
          ((T = N(T + p - (p * g + l * C) + m)),
          (y = N(y + l - (p * S + l * b) + x))),
        (r || n) &&
      ...
      for (u in Tt)
        (f = r[u]),
          ...
          f !== h &&
            ...
            ((d = X(f)),
            (p = X(h)),
            (c = d !== p ? Dt(i, u, f, p) : parseFloat(f)),
            (_ = parseFloat(h)),
            (t._pt = new Z(t._pt, a, u, c, _ - c, Ei)),
            (t._pt.u = p || 0),
            t._props.push(u));
      Wr(a, r);
    };
  ...
  var Ni = {
    ...
    init: function (t, e, i, r, n) {
      ...
      for (l in e)
        if (
          l !== "autoRound" &&
          ((h = e[l]), !(J[l] && Ti(l, e, i, r, t, n)))
        ) {
          if (
            ((d = typeof h),
            (p = Ve[l]),
            d === "function" && ((h = h.call(i, r, t, n)), (d = typeof h)),
            d === "string" && ~h.indexOf("random(") && (h = ie(h)),
            p)
          )
            p(this, t, l, h, i) && (C = 1);
            ...
            if (
              (u && l in u
                ? ((f =
                    typeof u[l] == "function" ? u[l].call(i, r, t, n) : u[l]),
              ...
              l in vt &&
                (l === "autoAlpha" &&
                  (_ === 1 && xt(t, "visibility") === "hidden" && c && (_ = 0),
              ...
              if (
                ...
                (this._pt = new Z(
                  ...
                  "scaleY",
                  g.scaleY,
                  (v ? Vt(g.scaleY, v + c) : c) - g.scaleY || 0,
                  Ei
                )),
                  (this._pt.u = 0),
                  s.push("scaleY", l),
                ...
                b.push(ht, 0, a[ht]),
                  ...
                  g.svg
                    ...
                    : ((x = parseFloat(h.split(" ")[2]) || 0),
                      x !== g.zOrigin && Mt(this, g, "zOrigin", g.zOrigin, x),
                      Mt(this, a, l, Ue(f), Ue(h)));
                continue;
              } else if (l === "svgOrigin") {
                Ai(t, h, 1, S, 0, this);
                continue;
            ...
            T || (l in a ? b.push(l, 0, a[l]) : b.push(l, 1, f || t[l])),
              s.push(l);
          }
        }
      C && Pi(this);
    ...
    getSetter: function (t, e, i) {
      ...
      return (
        r && r.indexOf(",") < 0 && (e = r),
        e in Tt && e !== ht && (t._gsap.x || xt(t, "x"))
          ? i && Lr === i
            ? e === "scale"
              ? Ls
              : Fs
            : (Lr = i || {}) && (e === "scale" ? zs : Ns)
          : t.style && !Fe(t.style[e])
          ? As
          : ~e.indexOf("-")
          ? Rs
          : Be(t, e)
      ...
      if (r)
        for (n || r.removeChild(this); n--; ) {
          ...
          typeof s != "object"
            ...
            n
              ? r.insertBefore(this.previousSibling, s)
              : r.replaceChild(s, this);
        }
    }
    typeof Element < "u" &&
  ...
  function Jr(o) {
    ...
    return (
      ...
      jt(t).reduce((e, i) => [...e, ...jt(i).filter(js)], [])
    );
  }
  ...
  var $i = "\\ud800-\\udfff",
    ...
    no = hn + fn + ro,
    so = `(?:${[`${sn}${Ii}?`, Ii, on, an, eo].join("|")}
)`,
    oo = RegExp(`${Bi}(?=${Bi})|${so}${no}`, "g"),
    ao = [un, $i, en, rn, nn],
    uo = RegExp(`[${ao.join("")}]`);
  function fo(o) {
    return o.split("");
    ...
    return (
      t &&
        Object.keys(t).forEach((i) => {
          ...
          n === null ||
            n === "" ||
            (i === "children" ? e.append(...jt(n)) : e.setAttribute(i, n));
        }),
      e
    );
  }
  ...
  function cn(o, t) {
    ...
    let r = jt(o.childNodes);
    if (r.length && (dt(o, "isSplit", !0), !Gt(o).isRoot)) {
  ...
  function _n(o) {
    Gt(o).isWord
      ? (tn(o), o.replaceWith(...o.childNodes))
      : jt(o.children).forEach((t) => _n(t));
  }
  ...
  function yo(o, t, e) {
    ...
    return (
      t.absolute &&
        ((c = { left: o.offsetLeft, top: o.offsetTop, width: o.offsetWidth }),
        (h = o.offsetWidth),
        (f = o.offsetHeight),
        dt(o, { cssWidth: o.style.width, cssHeight: o.style.height })),
      jt(n).forEach((y) => {
        ...
        /^br$/i.test(y.nodeName) ||
          (i.lines &&
            g &&
            ((u === null || b - u >= T) && ((u = b), s.push((a = []))),
            a.push(y)),
          t.absolute && dt(y, { top: b, left: w, width: S, height: C }));
      }),
      d && d.removeChild(o),
      i.lines &&
        ((_ = s.map((y) => {
          let g = Vi(r, {
            ...
            style: `display: block; text-align: ${x}; width: 100%;`,
          });
          dt(g, "isLine", !0);
          ...
          return (
            l.appendChild(g),
            y.forEach((C, b, w) => {
              let { isWordEnd: P, top: O, height: D } = Gt(C),
                L = w[b + 1];
              (S.height = Math.max(S.height, D)),
                (S.top = Math.min(S.top, O)),
                g.appendChild(C),
                P && Gt(L).isWordStart && g.append(" ");
            }),
      ...
      t.absolute &&
        ...
        (o.style.height = `${f}px`),
        jt(n).forEach((y) => {
          let { isLine: g, top: S, left: C, width: b, height: w } = Gt(y),
            P = Gt(y.parentElement),
            O = !g && P.isLine;
          (y.style.top = `${O ? S - P.top : S}px`),
            (y.style.left = g ? `${c.left}px` : `${C - (O ? c.left : 0)}px`),
            (y.style.height = `${w}px`),
            (y.style.width = g ? `${c.width}px` : `${b}px`),
  ...
  var ae = qt(Yi, {}),
    bt = class {
      ...
      static revert(t) {
        Jr(t).forEach((e) => {
          let { isSplit: i, html: r, cssWidth: n, cssHeight: s } = Gt(e);
          i &&
            ((e.innerHTML = r),
            (e.style.width = n || ""),
            (e.style.height = s || ""),
  ...
  var Xi = class extends Xe {
      constructor(t) {
        let e = {
          ...
          aSplit: t.dataset.aSplit || "words",
          aDuration: +t.dataset.aDuration,
          aEach: +t.dataset.aEach,
          aDelay: +t.dataset.aDelay,
          aEase: t.dataset.aEase ?? "expo.out",
          aFrom: t.dataset.aFrom ?? "start",
        };
        console.log("CONFIG: ", e),
          super({ element: t, config: e }),
          (this.config = e),
          (this.item = t),
          (this.animated = xo(t)),
          (this.a = { y: "120%", x: "0%" }),
